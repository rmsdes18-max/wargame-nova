-- CORRECTED Classification SQL
-- Includes new aliases + proper active/inactive classification
...
BEGIN
  ...
  -- NEW ALIASES (19 total)
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'Cako♂`', 'Cakoぞ゜', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'Cakoそ', 'Cakoぞ゜', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'Cakoヌ*', 'Cakoぞ゜', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'Cakoヌ゛', 'Cakoぞ゜', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'XSI3fR0', 'XSt3fRO', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'XSt3lR0', 'XSt3fRO', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'ᐸZavaᐳ', 'くZava', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'ちロパひ', '与ロI爪ひ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'ちロ爪な', '与ロI爪ひ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'ちロ爪ひ', '与ロI爪ひ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'モルモレツモ', 'モ几モしソモ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'モル毛レソモ', 'モ几モしソモ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '下ひれだYる', '下ひれ长Yるる', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '下ひれ長Yる', '下ひれ长Yるる', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '乃øøƒĭ丨モ', '乃oo爪|モ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '乃ㄚGXㄒZひ', '乃卍G乂丁乙ひ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '乃中GXすZひ', '乃卍G乂丁乙ひ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '卄яGひルツ', '卄卍Gひ几ツ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, '计书Gαルツ', '卄卍Gひ几ツ', 'member') ON CONFLICT DO NOTHING;
  INSERT INTO aliases (guild_id, normalized_key, actual_name, type) VALUES (gid, 'Lᴜᴠ·Eᴠ·E', 'しuvモvモ', 'member') ON CONFLICT DO NOTHING;

  -- Ensure all 66 active members exist with status='active'
  ...
  -- Mark 22 unmatched war players as inactive
  ...
  -- Lᴜᴠ·Eᴠ·E: skipped — alias of しuvモvモ (active)
  ...
  -- ᐸZavaᐳ and くZava: skipped — くZava is active, ᐸZavaᐳ is its alias
