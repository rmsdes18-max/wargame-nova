...
function renderStatsMatchingV3(results){
  ...
  html += '<style id="stats-v3-css">'
    ...
    +'.sm3-attention-header{background:linear-gradient(135deg,rgba(212,225,87,.15) 0%,rgba(212,225,87,.05) 100%);padding:14px 20px;display:flex;align-items:center;gap:10px;border-bottom:1px solid var(--border);}'
    ...
    +'.sm3-toggle-option.active{background:rgba(212,225,87,.15);color:var(--accent);}'
    ...
    +'.sm3-party-member.new-match{background:rgba(212,225,87,.1);margin:0 -8px;padding:4px 8px;border-radius:4px;}'
    ...
    +'.sm3-editable-stat:hover{background:rgba(212,225,87,.15);}'
